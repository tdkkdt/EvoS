...
namespace EvoS.Framework.Misc
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(GameBalanceVars));
        ...
        public class GameResultBadge : IUniqueID
        {
            ...
            public bool DoStatsMeetMinimumRequirementsForBadge(
                StatDisplaySettings.IPersistatedStatValueSupplier StatSupplier)
            {
        ...
        public ColorUnlockData GetColorUnlockData(CharacterType characterType, int skinIndex, int patternIndex,
            int colorIndex)
        {
            return GetCharacterUnlockData(characterType)
                .skinUnlockData[skinIndex]
